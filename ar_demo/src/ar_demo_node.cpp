...
void axis_generate(visualization_msgs::msg::Marker &line_list, Vector3d &origin, int id)
{
    ...
    line_list.lifetime = rclcpp::Duration(0, 0); // infinite
...
void callback(const sensor_msgs::msg::Image::SharedPtr img_msg, const std::shared_ptr<const nav_msgs::msg::Odometry> pose_msg)
{
