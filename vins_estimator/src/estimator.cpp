...
void Estimator::setParameter()
{
    ...
    ProjectionFactor::sqrt_info = SQRT_ROOT_INFO_MAT_FOR_VISUAL_RESIDUAL * Matrix2d::Identity();
    ProjectionTdFactor::sqrt_info = SQRT_ROOT_INFO_MAT_FOR_VISUAL_RESIDUAL * Matrix2d::Identity();
    td = TD;
}
